# FeatDistill Inference

This implementation is for **NTIRE 2026 Challenge on Robust AI-Generated Image Detection in the Wild**.  

It implements the UESTC four-expert ensemble model.
...
Each expert obtains `P(fake)` (the fake-image probability) from class index 1. The final score is the average of the four probabilities.
